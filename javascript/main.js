...
function bandMemberCardBuilder(variablehere) {
  for (var i=0; i<bandMembers[i]; i++) {
    var info = "";
        info += "<div class='band-container'>";
          info += "<img class='band-photo' src='" + bandMember.image + "'>";
          info += "<h2>" + bandMember.name + "</h2>";
          info += "<p>" + "<strong>Instrument: </strong>" + bandMember.instrument + "</p>";
          info += "<p>" + "<strong>Age: </strong>" + bandMember.age + "</p>";
          info += "<p>" + "<strong>Hometown: </strong>" + bandMember.hometown + "</p>";
          info += "<p>" + "<strong>Favorite Band: </strong>" + bandMember.favoriteBand + "</p>";
          info += "<p>" + "<strong>Favorite Semi-Solid: </strong>" + bandMember.favoriteSemiSolid + "</p>";
        info += "</div>";
        toDom(info, 'band-member-holder')
  }
};
  function toDom(cardInfo, bandMemberHolderDivId){
      var bandHolder = document.getElementById(bandMemberHolderDivId);
      bandHolder.innerHTML += cardInfo;
};
